...
# Toy data
items = [
    ["safari", "lions", "giraffes", "Enjoy this beautiful 3-day ride across Tanzania!\nYour satisfaction is guaranteed"],
    ["2-day snowboarding adventure", "winter sports", "snowboarding", "skiing", "mountain"],
    ["culture", "luxury", "all expenses paid shopping trip to New York City"]
]

user_initial_interests = [
    ["athletics", "nature"],
    ["art", "literature", "fashion"]
]
